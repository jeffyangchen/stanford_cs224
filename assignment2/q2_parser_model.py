...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        #
        # W = tf.get_variable(name='hidden_layer_weights',
        #                     initializer=initializer((self.config.n_features * self.config.embed_size,
        #                                             self.config.hidden_size)))
        # b1 = tf.get_variable(name='hidden_layer_bias', initializer=tf.zeros((self.config.hidden_size, )))
        # U = tf.get_variable(name='prediction_layer_weights',
        #                     initializer=initializer((self.config.hidden_size, self.config.n_classes)))
        # b2 = tf.get_variable(name='prediction_layer_bias', initializer=tf.zeros((self.config.n_classes, )))
        #
